...
<body>
        ...
        <div id="accordion" class="centerthis">
            ...
            <div>
             ...
             <input type="hidden" name="page" value="feedbackbox"></input>
             <input type="hidden" name="sessionid" value=" <%=session.getAttribute("id")%>"></input>
                <textarea name="feedback" style="margin: 0px; width: 968px; height: 89px;"></textarea>
                            <table align="center">
...
<input   type="submit" name="submit" value="Submit"></input>
                ...
                <br>
                <form name="input" method="post" action="<%=request.getContextPath() %>/AdvisorServlet">
             <input type="hidden" name="page" value="feedbackcancel"></input>
             <input type="hidden" name="sessionid" value=" <%=session.getAttribute("id")%>"></input>
                                         <table align="center">
<tr><td colspan="2" align="center">
