                ...
                <tr>
                                ...
                                <%
                                        ...
                                        if (!endSubmitted) {
                                            out.println("Please select an end time.\n");
                                                  	...
                                                  	<%
  								 Date date = new Date();
								out.println("<h3 align=\"center\">Current Date and Time</h3>");
                    ...
                    <td style="vertical-align: top; float: right; width:980px" >
                        <div id="timeaccordion"  >
                            <h3>Calendar</h3>
                            <div id="calendar" style="background-image: url(http://www.campusexplorer.com/media/560x420/The-University-of-Texas-at-Arlington-736B9B85.jpg);background-size: 100%" ></div>                        
